        ...
        <div class="col-md-12">
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-check mt-4">
                    <input class="form-check-input" type="checkbox" name="active" id="active" {{ !empty($product) && $product->active ? 'checked' : '' }}>
                ...
                <div class="form-check mt-4">
                    <input class="form-check-input" type="checkbox" name="is_new" id="is_new" {{ !empty($product) && $product->is_new ? 'checked' : '' }}>
                ...
                <div class="form-check mt-4">
                    <input class="form-check-input" type="checkbox" name="is_brand" id="is_brand" {{ !empty($product) && $product->is_brand ? 'checked' : '' }}>
